...
if (!usuarioAtivo.progressoTopicos[disciplinaAtual]) usuarioAtivo.progressoTopicos[disciplinaAtual] = {};
if (!usuarioAtivo.progressoTopicos[disciplinaAtual][assuntoId]) {
  usuarioAtivo.progressoTopicos[disciplinaAtual][assuntoId] = {
    respondidas: 0,
    acertos: 0,
    erros: 0,
    total: 5,
...
const progressoTopico = usuarioAtivo.progressoTopicos[disciplinaAtual][assuntoId];
progressoTopico.total = 5;
...
progressoTopico.respondidas += 1;
progressoTopico.acertos += 1;
...
progressoTopico.respondidas += 1;
progressoTopico.erros += 1;
    feedback.innerText = `Resposta incorreta ❌ (Resposta correta: ${correta})`;
    feedback.style.color = "red";
  }
  progressoTopico.concluido = progressoTopico.respondidas >= progressoTopico.total;
  document.getElementById("btnConfirmar").disabled = true;
